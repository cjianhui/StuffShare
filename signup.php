              ...
              <div class="form-group has-feedback">
                ...
                <div class="form-group">
                  <div class="input-icon">
                    ...
                    <input type="text" id="full_name" name="fullname" class="form-control" placeholder="Full Name" required>
                  </div>
                  <div class="help-block with-errors">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-icon">
                    ...
                    <input type="email" id="email" name="email" class="form-control" placeholder="Email Address" data-error="Bruh, that email address is invalid" required>
                  </div>
                  <div class="help-block with-errors">
                ...
                <div class="form-group">
                  <div class="input-icon">
                    ...
                    <input type="text" pattern="\d{8}" id="phonenumber" name="phonenumber" class="form-control" placeholder="Phone Number" required>
                  </div>
                  <div class="help-block with-errors">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="input-icon">
                    ...
                    <input type="password" class="form-control" id="confirm_password" data-match="#password" data-match-error="Whoops, these don't match"
