                ...
                <div class="inner-box">
                  ...
                  <div class="dashboard-wrapper">
                    <nav class="nav-table">
                      ...
                      ?>
                      <ul>
                        <li class="active"><a href="/user_bids.html#">All Listings (<?= pg_num_rows($result)?>) </a></li>
                          ...
                          for ($i=0; $i<min(5, pg_num_rows($result)); $i++) {
                            ...
                            <td data-title="Action">
                              <div class="btns-actions">
                                ...
                                <a class="btn-action btn-edit" title="Edit Listing" href="/user_bids.html#"><i class="lni-pencil"></i></a>
                                <a class="btn-action btn-delete" title="Delete Listing" href="/user_bids.html#"><i class="lni-trash"></i></a>
                              </div>
                            </td>
                          </tr>
                          <?php } ?>
