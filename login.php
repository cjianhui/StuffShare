...
if (isset($_SESSION['key'])) {
    ...
    $query = "SELECT username, role FROM account where username='" . $username . "' and password='" . hash(sha256, $password) . "'";
    ...
    if ($num_results < 1) {
        ...
        if ($row['role']=='admin') {
            $message = "<div class='alert alert-success text-center'><strong>Welcome Admin!</strong> Redirecting.. </div>";
